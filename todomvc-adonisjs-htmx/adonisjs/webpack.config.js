...
|
*/
// https://github.com/romanzy313/adonisjs-webpack-encore-typescript
/**/
Encore
	.addEntry("app", "./resources/js/app.ts")
	.enableTypeScriptLoader(function (/** @type {Record<string, any>} */tsConfig) {
...
|
*/
Encore.configureDevServerOptions((/** @type {Record<string, any>} */options) => {
	/**
